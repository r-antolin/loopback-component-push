...
GcmProvider.prototype._createMessage = function(notification) {
  ...
  var propDataNames = Object.keys(data);

  propDataNames.forEach(function(key) {
    if (data[key] !== null &&
  ...
  message.addNotification('title', notification.alert);
  message.addNotification('body', notification.messageFrom);
  message.addNotification('sound', notification.sound);
  message.addNotification('icon', notification.icon);
  message.addNotification('color', notification.color);
  message.addNotification('tag', notification.tag);
